...
export default function HashrateDisplay({ hashrate, unit, onRefresh, isRefreshing }: HashrateDisplayProps) {
  return (
    <View className="px-4 py-4">
      <View className="flex-row items-center justify-between mb-1">
        <View>
          <Text className="text-white text-sm font-medium">Overview</Text>
          <Text className="text-gmh-slate text-xs">Total Hashrate (Live from Braiins)</Text>
        </View>
        <TouchableOpacity 
          onPress={onRefresh} 
          className="p-2"
