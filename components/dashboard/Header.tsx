      ...
      <View className="flex-row items-center justify-between px-4 py-3">
        <View className="flex-row items-center gap-3">
          <TouchableOpacity onPress={onMenuPress}>
            <Menu size={22} color="#84CC16" />
          </TouchableOpacity>
          <View className="flex-row items-center gap-2">
            <View className="w-8 h-8 rounded-full bg-gmh-lime/20 items-center justify-center">
              <Text className="text-gmh-lime font-bold text-sm">G</Text>
            </View>
            <Text className="text-white text-base font-semibold">GreenMicroHash</Text>
          </View>
        </View>
          ...
          <TouchableOpacity onPress={onNotificationPress} className="relative p-1">
            ...
            {notificationCount > 0 && (
              <View className="absolute top-0 right-0 bg-gmh-lime w-4 h-4 rounded-full items-center justify-center">
                <Text className="text-gmh-dark text-[10px] font-bold">{notificationCount}</Text>
              </View>
            )}
          </TouchableOpacity>
